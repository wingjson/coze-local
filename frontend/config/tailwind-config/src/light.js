...
const lightModeVariables = {
  ...
  'coze-brand-6': '55, 105, 242' /* Slightly darker and more saturated */,
  'coze-brand-7': '33, 83, 224' /* A strong, deep blue */,
  'coze-brand-30': '14, 55, 181' /* A very dark blue, good for primary text */,
  'coze-brand-50': '8, 38, 133' /* The darkest shade, almost a navy */,

  /* --- Lighter Shades (for backgrounds, borders, hover effects) --- */
  'coze-brand-3': '132, 161, 255' /* A softer, lighter version of the base */,
  'coze-brand-2': '168, 187, 255' /* Lighter and less saturated */,
  'coze-brand-1': '201, 210, 255' /* A very light pastel blue */,
  'coze-brand-0': '227, 231, 255',
